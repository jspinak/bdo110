...
public class StorageTransitions {
    ...
    public boolean verifyArrival() {
        log.info("Verifying arrival at Storage");
        ...
        boolean found = action.find(storageState.getStorageWindow(), findOptions).isSuccess();

        if (found) {
            log.info("Successfully arrived at Storage");
        } else {
            log.error("Failed to verify arrival at Storage");
        }
